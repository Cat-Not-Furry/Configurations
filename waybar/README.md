...
Requiere `cnf-info` en PATH (`/usr/local/bin` tras `install`).
...
./hyperland/scripts/deploy-configs.sh --config   # incluye cnf-bin
...
- Ver también [`cnf-bin/TROUBLESHOOTING.md`](../cnf-bin/TROUBLESHOOTING.md).
