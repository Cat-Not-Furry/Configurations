#!/usr/bin/env bash
# Bloqueo i3: i3lock temático (classic/iceberg).
# Invocado por xss-lock, $mod+mod1+b y dmenu. No usar loginctl aquí: xss-lock ya
# escucha Lock de logind; loginctl lock-session + lock.sh creaba un bucle sin i3lock.
set -euo pipefail
