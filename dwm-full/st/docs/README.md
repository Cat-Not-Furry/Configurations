# Mi compilación de st (terminal simple)

![Mi compilación de st](st.png)
...
Luego compila e instala con `sudo make clean install`:
...
En el parche nordtheme realicé una modificación en el archivo `config.h`.
