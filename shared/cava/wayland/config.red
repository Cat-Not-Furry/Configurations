# Estilo: Rojo carmesí (Wayland)
# Slug palettes: red
# Copia manualmente a ~/.config/cava/config cuando quieras activarlo.

# Estilo: Verde retro terminal (X11 — gradiente verde fosforescente)
# Copia manualmente a ~/.config/cava/config cuando quieras activarlo.
...
foreground = '#C62828'
gradient = 1
gradient_color_1 = '#C62828'
gradient_color_2 = '#E53935'
gradient_color_3 = '#FF4081'
gradient_color_4 = '#6b8a3a'
